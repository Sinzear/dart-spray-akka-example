...
main: function() {
  ...
  W.HttpRequest_getString("http://localhost:3000/api/tasks", null, null).then$1(new G.main_closure(container));
},

main_closure: {"": "Closure;container_0",
  call$1: function(res) {
    J.forEach$1$ax(C.C_JsonCodec.decode$1(res), new G.main__closure(this.container_0));
  },
  $is_args1: true
},

main__closure: {"": "Closure;container_1",
  call$1: function(taskAsJson) {
    var newTask, t1, t2, t3, t4, t5;
    newTask = R.Task$fromJson(taskAsJson);
    t1 = J.get$children$x(this.container_1);
    t2 = document.createElement("li", null);
    t3 = J.get$children$x(t2);
    t4 = document.createElement("h3", null);
    t4.textContent = newTask.assignee;
    t5 = document.createElement("span", null);
    t5.textContent = newTask.content;
    t3.addAll$1(t3, [t4, t5, document.createElement("br", null), document.createElement("br", null)]);
    t1.add$1(t1, t2);
  },
  $is_args1: true
}},
...
InputElement: {"": "HtmlElement;", $isElement: true, "%": "HTMLInputElement"},
...
_ChildrenElementList: {"": "ListBase;_element,_childElements",
  ...
  addAll$1: function(_, iterable) {
    var t1, t2;
    for (t1 = new H.ListIterator(iterable, 4, 0, null), t2 = this._element; t1.moveNext$0();)
...
FilteredElementList: {"": "ListBase;_node,_childNodes",
  ...
  addAll$1: function(_, iterable) {
    var t1, t2;
    for (t1 = new H.ListIterator(iterable, 4, 0, null), t2 = this._childNodes._this; t1.moveNext$0();)
      t2.appendChild(t1._dev$_current);
  },
  get$length: function(_) {
...
["model", "model.dart", , R, {
Task: {"": "Object;id,assignee,content",
  Task$fromJson$1: function(json) {
    var t1 = J.getInterceptor$asx(json);
    this.id = t1.$index(json, "id");
    this.assignee = t1.$index(json, "assignee");
    this.content = t1.$index(json, "content");
  },
  static: {
Task$fromJson: function(json) {
  var t1 = new R.Task(null, null, null);
  t1.Task$fromJson$1(json);
  return t1;
}}
...
function dart_precompiled($collectedClasses) {
  ...
  function main_closure(container_0) {
    this.container_0 = container_0;
  }
  ...
  function main__closure(container_1) {
  ...
  function Task(id, assignee, content) {
    this.id = id;
    this.assignee = assignee;
    this.content = content;
  }
  Task.builtin$cls = "Task";
  if (!"name" in Task)
    Task.name = "Task";
  $desc = $collectedClasses.Task;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Task.prototype = $desc;
